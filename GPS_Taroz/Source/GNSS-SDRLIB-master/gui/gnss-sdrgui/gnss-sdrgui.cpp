...
int main(array<System::String ^> ^args)
{
	...
	GetThisPathA(curdir, MAX_PATH);
	SetCurrentDirectoryA(curdir);

	String^ string_curdir = gcnew String(curdir);
	...
	if(hNavi!=NULL)
	{
		WaitForSingleObject(hNavi,INFINITE);
		CloseHandle(hNavi);
		hNavi=NULL;
	}
    return 0;
...
System::Void SDR::start(System::Object^ obj)
{
	...
	/* IRNSS */
	setsdrini(form->cb_IR01->Checked, 1, SYS_IRNSS, form->rb_C_FE2->Checked, true, false, false, &sdrini);
	setsdrini(form->cb_IR02->Checked, 2, SYS_IRNSS, form->rb_C_FE2->Checked, true, false, false, &sdrini);
	setsdrini(form->cb_IR03->Checked, 3, SYS_IRNSS, form->rb_C_FE2->Checked, true, false, false, &sdrini);
	setsdrini(form->cb_IR04->Checked, 4, SYS_IRNSS, form->rb_C_FE2->Checked, true, false, false, &sdrini);
	setsdrini(form->cb_IR05->Checked, 5, SYS_IRNSS, form->rb_C_FE2->Checked, true, false, false, &sdrini);
	setsdrini(form->cb_IR06->Checked, 6, SYS_IRNSS, form->rb_C_FE2->Checked, true, false, false, &sdrini);
	setsdrini(form->cb_IR07->Checked, 7, SYS_IRNSS, form->rb_C_FE2->Checked, true, false, false, &sdrini);
